  <!-- Testimonials 9 -->
  <section class="fdb-block" style="background-image: url(/mediamaze-starter/wp-content/uploads/2020/07/9.svg); background-size: contain;">
    <div class="container">
      ...
      <div class="row mt-5 align-items-center justify-content-center">
        <div class="col-md-8 col-lg-4">
          <div class="fdb-box">
            <div class="row no-gutters align-items-center">
              <div class="col-3">
                <img alt="image" class="img-fluid rounded" src="https://i.pravatar.cc/300?img=26">
              </div>
        ...
        <div class="col-md-8 col-lg-4 mt-4 mt-lg-0">
          <div class="fdb-box">
            <div class="row no-gutters align-items-center">
              <div class="col-3">
                <img alt="image" class="img-fluid rounded" src="https://i.pravatar.cc/300?img=23">
              </div>
              <div class="col-8 ml-auto">
                <p>
                  <strong>Person Name</strong><br>
        ...
        <div class="col-md-8 col-lg-4 mt-4 mt-lg-0">
          <div class="fdb-box">
            <div class="row no-gutters align-items-center">
              <div class="col-3">
                <img alt="image" class="img-fluid rounded" src="https://i.pravatar.cc/300?img=30">
              </div>
              <div class="col-8 ml-auto">
                <p>
                  <strong>Person Name</strong><br>
